...
import br.edu.unicesumar.core.entity.ValidarUsuario;
...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        if(validaCampos()){
            ...
            ValidarUsuario acess = new ValidarUsuario();
            
            if(acess.usuarioComAcesso(user)){
                JOptionPane.showMessageDialog(rootPane, "Acesso Concedido");
            }else {
